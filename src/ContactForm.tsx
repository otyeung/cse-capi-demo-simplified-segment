...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Manual analytics.track() call - wait for analytics to be ready
      if (window.analytics) {
        window.analytics.ready(() => {
          ...
          window.analytics.track('Sign Up', trackPayload, {}, () => {
            console.log(
              '[DEBUG] Track event callback fired - event sent successfully!'
            )
          })
        ...
        console.error('[DEBUG] window.analytics is not available')
      }
